...
<section class="categories-grid">
    <div class="category-card card-portrety">
        <img src="/assets/img/portrety/home_optimized.jpg" alt="Fotenie portrétov" fetchpriority="high" loading="eager">
        <div class="category-overlay">

            <a href="/portfolio/portrety" class="category-btn">
                <span class="btn-title">PORTRÉTY</span>
            </a>
        </div>
    </div>
    <div class="category-card">
        ...
        <div class="category-overlay">
            <a href="/portfolio/sport" class="category-btn">
                <span class="btn-title">ŠPORT</span>
            </a>
        </div>
    </div>
    <div class="category-card">
